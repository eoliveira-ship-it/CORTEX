...
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
-- Script        : 030_spool_Extract_CRRCORP_vPACT.sql                              --
...
--       RPAD(' ', 10)||    --taux pondÔøΩration baloise
    ...
    RPAD(' ', 1) ||
     ...
     RPAD (' ', 5)||
		 RPAD(nvl(C_ENR.CD_TYPE_PROD_BANCAIRE,' '),6,' ')||
     RPAD(nvl(TO_CHAR(C_ENR.DT_ARRETE, 'YYYYMMDD'),' '),8)|| -- Klx US273 23/12/2021 alimenter le champ P1 3.3 'Date de valeur' avec la date d'arr√™t√© en cours
     RPAD (' ', 7)||
...
-- 16/07/2018 CDS ATOS (JMP) ANACREDIT Sprint 12 US430 => Mettre dans blancs si le montant de premie dÔøΩblocage de fond est nul.
...
-- fin 16/07/2018 CDS ATOS (JMP) 
         ...
         CASE WHEN C_ENR.CD_MOTIF_SCO_LC0267 is NULL then RPAD(' ', 3) ELSE LPAD(C_ENR.CD_MOTIF_SCO_LC0267,3,'0') END ||  -- 26/02/2019 - CDS ATOS (GBD) - US740  P1 22.71  (col 2852) Motif passage engagemt douteux (0 ÔøΩ gauche)
	...
	--Fin MANTIS 11611	
     ...
     RPAD(NVL(C_ENR.CD_PAYS_BIEN_FINAN, ' '),2,' ')|| -- 31.10 -- KLx : Mantis 64749
		 ...
		 RPAD (' ', 19)||
		 RPAD (' ', 3)||
     --DEBUT: KLx Risques Leasing (BA): US 275 - Score 6 Dur√©e initiale/totale du pr√™t
     RPAD ('+', 1)|| -- P1 31.17a
     ...
     --FIN: KLx Risques Leasing (BA): US 275 - Score 6 Dur√©e initiale/totale du pr√™t
     RPAD (' ', 6)||
		 RPAD (' ', 1)||
    ...
    -- Fin Klx US 276 CRRV4.3 - ajout champ P1 31.22
     ...
     RPAD(' ',1) || -- Fin P1 31c
		 ...
		 RPAD (' ', 19)||
		 RPAD (' ', 3)||
		 'EUR'|| --DÔøΩbut P1 50 --M11665 modif VFN
    ...
    case when C_ENR.DUREE_MRTR is not null then '+'||LPAD(C_ENR.DUREE_MRTR,5,'0') else RPAD(' ',6) end ||--P1 21.29 pos 4907
		...
		RPAD(' ',15)|| --P1 21.32 pos 4941 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.33 pos 4956 - VIDE => point fermÈ
		RPAD(' ',12)|| --P1 15 pos 4959 - VIDE => point fermÈ
		RPAD(' ',12)|| --P1 16 pos 4971 - VIDE => point fermÈ
		RPAD(' ',12)|| --P1 14 pos 4983 - VIDE => point fermÈ
		RPAD(' ',12)|| --P1 50.20 pos 4995 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 50.21 pos 5007 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.34 pos 5026 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.35 pos 5027 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 21.36 pos 5028 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.37 pos 5047 - VIDE => point fermÈ
		RPAD(' ',10)|| --P1 21.47 pos 5050 - VIDE => point fermÈ
		RPAD(' ',7)|| --P1 21.48 pos 5060 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 21.49 pos 5067 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.50 pos 5086 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 21.51 pos 5089 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.52 pos 5108 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 21.53 pos 5111 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.54 pos 5130 - VIDE => point fermÈ
		...
		RPAD(' ',1)|| --P1 21.41 pos 5139 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.42 pos 5140 - VIDE => point fermÈ
 	  RPAD(pack_utilitaire.F_FORMAT_TAUX_15(C_ENR.ETV_RATIO),15)||--P1 21.43 pos 5141
		RPAD(' ',1)|| --P1 21.56 pos 5156 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.57 pos 5157 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.58 pos 5158 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.59 pos 5159 - VIDE => point fermÈ
		RPAD(' ',15)|| --P1 21.60 pos 5160 - VIDE => point fermÈ
		RPAD(' ',10)|| --P1 21.61 pos 5175 - VIDE => point fermÈ
		RPAD(' ',10)|| --P1 21.62 pos 5185 - VIDE => point fermÈ
		RPAD(' ',19)|| --P1 21.63 pos 5195 - VIDE => point fermÈ
		RPAD(' ',3)|| --P1 21.64 pos 5214 - VIDE => point fermÈ
		RPAD(' ',5)|| --P1 21.65 pos 5217 - VIDE => point fermÈ
		RPAD(NVL(C_ENR.IND_UCC,' '),1)|| --P1 21.66 pos 5222 => point fermÈ
		RPAD(' ',1)|| --P1 21.67 pos 5223 - VIDE => point fermÈ
		RPAD(NVL(C_ENR.NIV_RISQUE_CRR3,' '),1)|| --P1 21.68 pos 5224 => point fermÈ
		RPAD(NVL(C_ENR.CD_NAT_OPE_ENG_CALC_FLOOR,' '),12)|| --P1 21.55 pos 5225 => point fermÈ
		RPAD(NVL(CASE WHEN C_ENR.CD_TYPE_RISQUE LIKE 'VAR%' THEN 'N' ELSE NULL END,' '),1)|| --P1 21.69 pos 5237 => point fermÈ
		RPAD(' ',20)|| --P1 21.89 pos 5238 - VIDE => point fermÈ
		RPAD(' ',10)|| --P1 21.90 pos 5258 - VIDE => point fermÈ
		...
		RPAD(' ',1)|| --P1 21.79 pos 5535 => point fermÈ
...
------------------------------------------------------------------------------------------------------------------------
    ...
    select
       ...
       RPAD(' ', 10)||  -- longueur : 1+2+7	| Fin 0
       RPAD(NVL(C_ENR.ID_TIERS_CALC, ' '), 20)||
       --RPAD(NVL(C_ENR.ID_CENTRAL_TIERS, ' '), 10)||   --dans la synthese il est dit ÔøΩ blanc pour les tre5 mais aujourd hui nous la renseignons pour tous
       RPAD(' ', 10)||
       RPAD(NVL(C_ENR.ID_AUTORISATION, ' '), 30)||
       RPAD(NVL(C_ENR.ID_LIGNE_DET, ' '), 30)||
       RPAD(' ', 40)||
       ...
       RPAD(' ', 20)||	-- Fin 1
       RPAD(NVL(C_ENR.CD_METHODO_BALE2, 'STD'),7)||
       RPAD(NVL(C_ENR.CODE_TRAIT_MOTEUR, '01'),2)|| -- M56405 change code moteur de 07 ÔøΩ 01
       'Y'||
       RPAD(C_ENR.CD_TYPE_RISQUE,6)||
       NVL(C_ENR.CD_PORTEFEUILLE_BOOKING,'B')||
       RPAD(C_ENR.CD_LIGNE_METIER,5)||
...
--       RPAD(' ', 10)||    --taux pondÔøΩration baloise
    ...
    --Fin - CDS AtoS FAD - M48783 - Retour sur modification US731 / MNT_SOLDE
       ...
       -- 08/12/2020 - CDS ATOS (CPD) - US 238 - Anacredit Leasing- Revoir la rÔøΩgle d'alimentation des montant CBI en cas d'arriÔøΩrÔøΩ
...
-- fin 16/07/2018 CDS ATOS (JMP) ANACREDIT Sprint 12 US430 
    ...
    case when C_ENR.DUREE_MRTR is not null then '+'||LPAD(C_ENR.DUREE_MRTR,5,'0') else RPAD(' ',6) end ||--P1 21.29 pos 4907
		...
		RPAD(NVL(C_ENR.IND_EXPO_ADC,' '),1)|| --P1 21.39 pos 5137
		RPAD(' ',1)|| --P1 21.40 pos 5138 - A REMPLIR (v1.5) crÈer sur la BD?
		RPAD(' ',1)|| --P1 21.41 pos 5139 - VIDE => point fermÈ
		RPAD(' ',1)|| --P1 21.42 pos 5140 - VIDE => point fermÈ
 	  RPAD(pack_utilitaire.F_FORMAT_TAUX_15(C_ENR.ETV_RATIO),15)||--P1 21.43 pos 5141
		RPAD(' ',1)|| --P1 21.56 pos 5156 - VIDE => point fermÈ
...
--       RPAD(' ', 10)||    --taux ponderation baloise
      ...
      --06/02/2019 - CDS ATOS (SQN) US 654
       ...
       --Fin SQN
       -- Debut 3.2Bis
      --NVL(C_ENR.CD_ARR_PAIEMENT, 'N')|| -- US 263 - KLx Risque (VDC) - On met √ßa pour le moment
      'N'|| -- US 263 A VOIR
       NVL(C_ENR.CD_IMP_PRUDENT, 'N')||
       NVL(C_ENR.TOP_ENG_DOUTEUX, 'N')||
       Case When C_ENR.TOP_ENG_DOUTEUX = 'Y' then to_char(nvl(C_ENR.DT_ENG_DOUTEUX,C_ENR.dt_arrete), 'YYYYMMDD')
...
--         RPAD(' ',3)||
    ...
    --FIN: KLx Risques Leasing (BA): US 275 - Score 6 Dur√©e initiale/totale du pr√™t
     ...
     RPAD (' ', 19)|| --Debut 31 e
		 ...
		 RPAD (' ', 19)||
		 RPAD (' ', 3)||
		 'EUR'|| --DÔøΩbut 50 --M11665 modif VFN
		 RPAD(NVL(C_ENR.PCEC_MNT_RISQUE, ' '), 12)||
		 RPAD(pack_utilitaire.f_format_montant_bis2(C_ENR.MNT_RISQUE),19) ||
		 RPAD(' ',12)||
		 RPAD(' ',19)||
...
select
      ...
      NVL(C_ENR.CD_ARR_PAIEMENT,'N')|| --P1 5.5 -- 03/12/2021 - KLx Risque (VDC) - US 263 -  CRR Corporate - Score 7 'Indicateur Arri√©r√© de paiement' 
      RPAD(' ',1)||
...
-- 20/03/2019 - CDS AtoS FAD - CRRV4.2 US731 - Complement
	  ...
	  NVL(C_ENR.CD_DEVISE_CRD,'EUR')|| -- P1 4.13 Devise du capital restant dÔøΩ
-- Fin - CDS AtoS FAD - CRRV4.2 US731 - Complement
	  ...
	  (
	  	...
	  	ELSE
	  		RPAD(' ',3)
	  	END
	   )|| -- P1 4.7 Devise des intÔøΩrÔøΩts restant dus
	  -- Fin - CDS AtoS FAD - CRRV4.2 US731 - Complement
	  ...
	  --3.4Bis-CREDIT-BAIL-camp ÔøΩ blanc
	  RPAD(' ',69)||
   	  RPAD(nvl(C_ENR.cla_comp_ref_act,' '),3)||
--08/02/2019 - CDS AtoS FAD - CRRV4.2 US662 - TRE2_TRE4
	  ...
	  --13/02/2019 - CDS ATOS (SQN) - CRRV4.2 - Correctif : devise ÔøΩ EUR par dÔøΩfaut.
...
--08/02/2019- CDS AtoS FAD - CRRV4.2 US662 - TRE2_TRE4
	  ...
	  --US740 RPAD(NVL(C_ENR.CD_MOTIF_SCO_LC0267, ' '), 3, ' ')|| -- RÔøΩtablissement de CD_MOTIF_SCO_LC0267 --P1_22_71_MOTIF_DU_PASSAGE_EN_ENGAGEMENT_DOUTEUX
      CASE WHEN C_ENR.CD_MOTIF_SCO_LC0267 is NULL then RPAD(' ', 3) ELSE LPAD(C_ENR.CD_MOTIF_SCO_LC0267,3,'0') END ||  -- 26/02/2019 - CDS ATOS (GBD) - US740  P1 22.71  (col 2852) Motif passage engagemt douteux (0 ÔøΩ gauche)
	  RPAD(NVL(C_ENR.BUCKET_IFRS9, ' '), 2, ' ')|| -- Alimentation HN : p_update_origine_p1 --P1_22_72_BUCKET_IFRS9
	  RPAD(' ', 10)||--P1 22.73
	  RPAD(' ', 10)||--P1 22.74
...
WHERE 1     =1
  ...
  AND A_EXTRAIRE      ='O'
    and (C_ENR.cd_conso_cpt = :ENTITE or :ENTITE = 'TOTAL' )
  --CDS_ATOS (MNE) - 20/05/2021 - Mantis 57292 - Eevolution de la rÔøΩgle de gestion pour restructuration
...
select
			...
			RPAD(' ',2)||
			RPAD(' ',8)||
			NVL(C_ENR.CD_ARR_PAIEMENT,'N')|| -- P1 5.5 -- us 263 - KLx Risque (VDC) - CRR Corporate - Score 7 'Indicateur Arri√©r√© de paiement'
			RPAD(' ',1)|| -- P1 4.1
...
select
  ...
  --Fin - CDS AtoS FAD - M48783 - Retour sur modification US731 / MNT_SOLDE
      ...
      RPAD(' ',2)||
      RPAD(' ',3)||
      --3.5.Classification comptable de rÔøΩfÔøΩrence des actifs
      RPAD(nvl(C_ENR.cla_comp_ref_act,' '),3)||
      RPAD(' ',12)||
      RPAD(' ',1)||
      RPAD(' ',16)||
      ...
      RPAD(' ',2)||
      RPAD(' ',3)||
      --3.6 TITRES  cREANCE - champs ÔøΩ blanc car non applicables pour ce type de risque
      RPAD(' ',1)||
      RPAD(' ',2)||
...
--06/02/2019 - CDS AtoS FAD - CRRV4.2 US662 - VAR104
      --RPAD('3',1)|| --P1 22.36 -> non alimentÔøΩ dans la notice
      RPAD(NVL(C_ENR.IND_RMB_ANTICIPE,' '),1,' ')||   -- 18/02/2019 - CDS ATOS (GBD) - US731 P1 22.36
      -- DEBUT: projet OMP - sous-tache SIRL-236
      RPAD(' ', 177)|| -- P1 22.37 jusq'au P1 22.62
      RPAD(' ', 8)||   -- P1 22.63 :: projet OMP - ici doit etre VIDE
