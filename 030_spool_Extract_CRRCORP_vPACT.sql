...
select
     ...
     as lignedetail1,
       ...
       RPAD(' ',19)||   -- pos 5193 
       RPAD(' ',3)||   -- pos 5212 
       RPAD(' ',50)||   -- pos 5215  P1 21.65 (SIRL-1223 5 -> 50)
       RPAD(NVL(P1_21_66,' '),1)||   -- pos 5265  P1_21_66
       RPAD(' ',1)||   -- pos 5266 
       RPAD(NVL(P1_21_68,' '),1)||   -- pos 5267  P1_21_68
       RPAD(NVL(P1_21_55,' '),12)||   -- pos 5268  P1_21_55
       RPAD(NVL(P1_21_69,' '),1)||   -- pos 5280  P1_21_69
       RPAD(' ',20)||   -- pos 5281 
       RPAD(' ',10)||   -- pos 5301 
       RPAD(NVL(P1_8_13,' '),1)||   -- pos 5311  P1_8_13
       RPAD(NVL(P1_21_71,' '),40)||   -- pos 5312  P1_21_71
       RPAD(NVL(P1_21_72,' '),40)||   -- pos 5352  P1_21_72
       RPAD(NVL(P1_21_73,' '),40)||   -- pos 5392  P1_21_73
       RPAD(NVL(P1_21_74,' '),40)||   -- pos 5432  P1_21_74
       RPAD(NVL(P1_21_75,' '),40)||   -- pos 5472  P1_21_75
       RPAD(NVL(P1_21_76,' '),40)||   -- pos 5512  P1_21_76
       RPAD(NVL(P1_21_77,' '),11)||   -- pos 5552  P1_21_77
       RPAD(NVL(P1_21_78,' '),12)||   -- pos 5563  P1_21_78
       RPAD(' ',1)||   -- pos 5575 
       RPAD(' ',2)||   -- pos 5576 
       RPAD(' ',1)||   -- pos 5578 
       RPAD(NVL(P1_21_80,' '),3)||   -- pos 5579  P1_21_80
       RPAD(pack_utilitaire.F_FORMAT_TAUX(P1_21_81),10)||   -- pos 5582  P1_21_81
       RPAD(pack_utilitaire.F_FORMAT_TAUX(P1_21_82),10)||   -- pos 5592  P1_21_82
       RPAD(' ',15)||   -- pos 5602 
       RPAD(' ',15)||   -- pos 5617 
       RPAD(' ',15)||   -- pos 5632 
       RPAD(NVL(P1_21_86,' '),1)||   -- pos 5647  P1_21_86
       RPAD(NVL(P1_21_87,' '),1)||   -- pos 5648  P1_21_87
       RPAD(NVL(P1_21_88,' '),1)||   -- pos 5649  P1_21_88
       RPAD(' ',19)||   -- pos 5650 
       RPAD(' ',3)||   -- pos 5669 
       RPAD(' ',5)||   -- pos 5672 
       RPAD(' ',20)||   -- pos 5677 
...
select
       ...
       RPAD(' ',1)||   -- pos 1389 
       RPAD(' ',29)||   -- pos 1390 
       LPAD(ABS(TRUNC(P1_3_20)),2,'0')||   -- pos 1419  P1_3_20
       LPAD(ABS(MOD(P1_3_20 *10000,10000)),4,'0')||   -- pos 1421  P1_3_20
...
select
     ...
     as lignedetail1,
       ...
       RPAD(' ',11)||   -- pos 5552 
       RPAD(' ',12)||   -- pos 5563 
       RPAD(NVL(P1_21_94,' '),1)||   -- pos 5575  P1_21_94
       RPAD(' ',2)||   -- pos 5576 
       RPAD(NVL(P1_21_79,' '),1)||   -- pos 5578  P1_21_79
       RPAD(' ',3)||   -- pos 5579 
       RPAD(' ',10)||   -- pos 5582 
       RPAD(' ',10)||   -- pos 5592 
       RPAD(' ',15)||   -- pos 5602 
...
select
       ...
       RPAD(' ',1)||   -- pos 968  
       RPAD(NVL(P1_2_99,' '), 20)||   -- pos 969   P1_2_99
       pack_utilitaire.f_format_montant_bis2(nvl((P1_3_80),0))||   -- pos 989   P1_3_80
       RPAD(NVL(P1_3_81,' '),3,' ')||   -- pos 1008  P1_3_81
       RPAD(NVL(P1_3_82,' '),12,' ')||   -- pos 1011  P1_3_82
       RPAD(NVL(P1_3_83, ' '),1,' ')||   -- pos 1023  P1_3_83
       RPAD(NVL(P1_3_15, ' '),1,' ')||   -- pos 1024  P1_3_15
       RPAD(NVL(P1_13_10, ' '),25,' ')||   -- pos 1025  P1_13_10
       RPAD(NVL(P1_3_16, ' '),1,' ')||   -- pos 1050  P1_3_16
       RPAD(NVL(P1_3_17, ' '),25,' ')||   -- pos 1051  P1_3_17
       RPAD(NVL(P1_3_19, ' '),3,' ')||   -- pos 1076  P1_3_19
       pack_utilitaire.f_format_montant_bis2(nvl((P1_3_84),0))||   -- pos 1079  P1_3_84
       RPAD(NVL(P1_3_85, ' '),3,' ')||   -- pos 1098  P1_3_85
       pack_utilitaire.f_format_montant_bis2(nvl((P1_3_72),0))||   -- pos 1101  P1_3_72
       RPAD(NVL(P1_3_73, ' '),3,' ')||   -- pos 1120  P1_3_73
       RPAD(' ',3)||   -- pos 1123 
       RPAD(' ',1)||   -- pos 1126 
       RPAD(' ',16)||   -- pos 1127 
       RPAD(' ',2)||   -- pos 1143 
       ...
       RPAD(' ',1)||   -- pos 1658 
       RPAD(' ',1)||   -- pos 1659 
       RPAD(NVL(P1_3_36, ' '),1,' ')||   -- pos 1660  P1_3_36
       RPAD(' ',30)||   -- pos 1661 
       RPAD(' ',12)||   -- pos 1691 
       RPAD(' ',1)||   -- pos 1703 
       RPAD(' ',8)||   -- pos 1704 
       RPAD(NVL(P1_15_1, ' '),2,' ')||   -- pos 1712  P1_15_1
       RPAD(NVL(P1_15_2, ' '),2,' ')||   -- pos 1714  P1_15_2
       RPAD(' ',20)||   -- pos 1716 
       RPAD(' ',10)||   -- pos 1736 
       RPAD(' ',30)||   -- pos 1746 
       pack_utilitaire.f_format_montant_bis2(nvl((P1_3_86),0))||   -- pos 1776  P1_3_86
       RPAD(NVL(P1_3_87, ' '),3,' ')||   -- pos 1795  P1_3_87
       RPAD(NVL(P1_3_88, ' '),1,' ')||   -- pos 1798  P1_3_88
       RPAD(' ',30)||   -- pos 1799 
       RPAD(NVL(P1_11_1, ' '),3,' ')||   -- pos 1829  P1_11_1
       RPAD(NVL(P1_3_76, ' '),1,' ')||   -- pos 1832  P1_3_76
       RPAD(NVL(P1_3_77, ' '),1,' ')||   -- pos 1833  P1_3_77
       RPAD(' ',20)||   -- pos 1834 
       RPAD(' ',10)||   -- pos 1854 
       (CASE WHEN P1_11_2 >=0 THEN '+' ELSE '-' END)||   -- pos 1864  P1_11_2
       LPAD(ABS(TRUNC(NVL(P1_11_2,0))),4,'0')||   -- pos 1865  P1_11_2
       RPAD(' ',5)||   -- pos 1869 
       ...
       RPAD(NVL(P1_10_20, ' '),2,' ')||   -- pos 1918  P1_10_20
       RPAD(NVL(P1_10_1, ' '),3,' ')||   -- pos 1920  P1_10_1
