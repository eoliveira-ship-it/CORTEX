...
| 10 | Histórico no HCRR (`030_spool_data.sql` + `030_spool_9M.sql`) e documento SFD/STD único | depois | **Só depois que o cliente validar os dados** (decisão de 2026-09-17). Não iniciado |
